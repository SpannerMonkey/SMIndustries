...
public class SMIrudder : PartModule
{
    [KSPField]
    ...
    {
        power += 0.01f;        
        Debug.Log("SMIrudder power: " + power);
    }
    ...
    public void increaseRange()
    {
        ...
        Debug.Log("SMIrudder range: " + range);
    }
    ...
    public void cycleForceAxis()
    {
        ...
        Debug.Log("SMIrudder forceAxis: " + forceAxis);
    }
    ...
    public void toggleRequiresWaterContact()
    {
        ...
        Debug.Log("SMIrudder req. water contact: " + requiresWaterContact);
    }
