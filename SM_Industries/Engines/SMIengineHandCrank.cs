...
{
    class SMIengineHandCrank : PartModule
    {
        private SMIengineWrapper engine;

        public override void OnStart(PartModule.StartState state)
        {
            base.OnStart(state);
            engine = new SMIengineWrapper(part);
            if (engine.type == SMIengineWrapper.EngineType.ModuleEngine)
            {
            ...
            else if (engine.type == SMIengineWrapper.EngineType.ModuleEngineFX)
            {
