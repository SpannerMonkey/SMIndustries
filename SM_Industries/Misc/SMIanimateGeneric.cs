...
public class SMIanimateGeneric : PartModule
{
    [KSPField]
    ...
    private bool animSpeedInited = false;
    ...
    public override void OnStart(PartModule.StartState state)
    {
        ...
        //popup = new FSGUIPopup(part, "SMIanimateGeneric", moduleID, FSGUIwindowID.animateGeneric + moduleID, windowRect, startDeployedString, new PopupElement(new PopupButton("Yes", "No", 0f, guiToggleEvent)));
