...
/// </summary>
public class SMgenericButtonHandlerID : MonoBehaviour
{
    ...
    /// <summary>
    /// The ID passed back to the function specified by mouseDownFunction. Allows for telling buttons apart. If not needed, consider using SMgenericButtonhandler (not ...ID)
    /// </summary>
    public int ID;
