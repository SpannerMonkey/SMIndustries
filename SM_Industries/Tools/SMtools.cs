...
namespace SMIndustries
{
    public static class SMTools
    {
        ...
        public static String PlugInDataPath = AppPath + "GameData/SM_Idustries/Plugin/";
        ...
        public static List<double> parseDoubles(string stringOfDoubles)
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                {
                    Debug.Log("SMtools: invalid float: [len:" + array[i].Length + "] '" + array[i]+ "']");
                }
            }
            return list;
        }
