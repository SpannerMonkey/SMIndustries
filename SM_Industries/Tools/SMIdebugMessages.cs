...
{
    public class SMIdebugMessages : MonoBehaviour
    {
        ...
        public SMIdebugMessages()
        {
        }

        public SMIdebugMessages(bool _debugMode, string _moduleName)
        {
        ...
        public SMIdebugMessages(bool _debugMode, OutputMode _outputMode, float _postToScreenDuration)
        {
            debugMode = _debugMode;
