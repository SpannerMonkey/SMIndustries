...
public class SMGUIPopup
{
    ...
    public SMGUIPopup(Part part, string module, int ID, int Windowlayer, Rect windowDimensions, string windowName, PopupElement defaultElement)    
    {
    ...
    public SMGUIPopup(Part part, string module, int ID, int Windowlayer, Rect windowDimensions, string windowName)
    {
        parentPart = part;
        moduleName = module;
        moduleID = ID;
    ...
    public SMGUIPopup(int Windowlayer, Rect windowDimensions, string windowName)
    {
        GUIlayer = Windowlayer;
        windowRect = windowDimensions;
        windowTitle = windowName;
